 ...
 * ```
 */
export declare class SmartCaptureError extends Error {
 ...
 * if it's already one.
 */
export declare function toSmartCaptureError(err: unknown, fallbackCode: SmartCaptureErrorCode, fallbackMessage: string): SmartCaptureError;
