 ...
 */
export const ImageCropper = /*#__PURE__*/forwardRef(function ImageCropper(props, ref) {
  const {
    uri,
    imageWidth,
    imageHeight,
   ...
   *  Gestures                                                         *
   * ----------------------------------------------------------------- */
  const panGesture = Gesture.Pan().averageTouches(true).onStart(() => {
  ...
  const pinchGesture = Gesture.Pinch().onStart(() => {
    ...
    tx.value = withTiming(next.tx, {
      duration: 120
    });
    ty.value = withTiming(next.ty, {
      duration: 120
    });
  });
  ...
  return /*#__PURE__*/React.createElement(View, {
    ...
    fill: overlayColor,
    mask: "url(#hole)"
  }), strokeWidth > 0 && strokeColor !== 'transparent' ? isCircle ? /*#__PURE__*/React.createElement(Circle, {
    cx: centerX,
    cy: centerY,
    r: overlayWidth / 2,
    fill: "none",
