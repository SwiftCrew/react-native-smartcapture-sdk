...
exports.SmartCaptureError = void 0;
exports.toSmartCaptureError = toSmartCaptureError;
/**
 ...
 * ```
 */
class SmartCaptureError extends Error {
 ...
 * if it's already one.
 */
exports.SmartCaptureError = SmartCaptureError;
function toSmartCaptureError(err, fallbackCode, fallbackMessage) {
