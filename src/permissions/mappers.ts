...
import {
  ...
  RESULTS,
  type Permission,
  type PermissionStatus as RNPStatus,
 ...
 */
export function mapStatus(status: RNPStatus): PermissionStatus {
  switch (status) {
 ...
 */
export function getCameraPermission(): Permission | null {
 ...
 */
export function getGalleryPermission(): Permission | null {
